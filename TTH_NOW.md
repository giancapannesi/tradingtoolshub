...
- Stage 2 eighth set is locally accepted and awaiting deployment: `/best/best-prop-firms-futures/`, `/review/chartlog/`, `/review/journalytix/`, and `/review/marketsmith/` rebuilt as locked static pages with official source links, stale URL corrections and public/dist parity.
